...
class CompanyPurchasesSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $company_products = [
            [
                'product' => $products[0],
                'csv_path' => 'app/kimpc_products/csv_techlabs-new/data222_techlabs_6months.csv',
            ],
            [
                'product' => $products[1],
                'csv_path' => 'app/kimpc_products/csv_techlabs-new/data187_techlabs_6months.csv',
            ],
            [
                'product' => $products[2],
                'csv_path' => 'app/kimpc_products/csv_techlabs-new/data708_techlabs_6months.csv',
            ],
            [
                'product' => $products[3],
                'csv_path' => 'app/kimpc_products/csv_techlabs-new/data55_techlabs_6months.csv',
            ],
            [
                'product' => $products[4],
                'csv_path' => 'app/kimpc_products/csv_techlabs-new/data249_techlabs_6months.csv',
            ],
        ];
        ...
        $company_products = [
            [
                'product' => $products[0],
                'csv_path' => 'app/kimpc_products/csv_jdcworld-new/data222_jdcworld_6months.csv',
            ],
            [
                'product' => $products[1],
                'csv_path' => 'app/kimpc_products/csv_jdcworld-new/data222_jdcworld_6months.csv',
