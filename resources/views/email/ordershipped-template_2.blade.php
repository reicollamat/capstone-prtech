...
<head>
    ...
    <!--[if !mso]><!-->
    <link
        href="https://fonts.googleapis.com/css?family=Noto+Serif:400,400i,700,700i|Raleway:400,400i,700,700i"
        rel="stylesheet"
    />
    <!--<![endif]-->
    <title>PR TECH</title>
                    ...
                    <td align="center" class="main" style="padding: 0px 0px 20px 0px">
                      ...
                      "
                            ...
                            "
                                        ...
                                        "
                                                                    >
                                                                        Use the code above to track your order
                                                                        when using Tracking Order in our Website
                                                                    </td>
                                                                </tr>
                                                                <!-- Button -->
                                                                <tr>
                                            ...
                                            <td class="footer" style="padding: 60px 30px">
                                                ...
                                                >
                                                    <tr>
                                                        <td
                                                            class="separator"
                                                            style="border-bottom: 1px solid #5e63d3"
                                                        ></td>
                                                    </tr>
                                                    <tr>
                                                        <td
                                                            class="text-footer pt30"
                                                            style="
                                    color: #a9ace3;
                                  ...
                                  "
                                                        >
                                                            Copyright &copy; 2023 PR TECH <br />Metro
                                  ...
                                  "
                                                        >
                                                            All Right Reserve PR TECH 2023
                                                            <a
                                                                href="#"
                                                                target="_blank"
                                                                class="link-footer-u"
