                                    ...
                                    <div class="card">
                                        <div class="row g-0">
                                            <div class="col-md-2 justify-content-center">
                                                <img src="{{asset($item['image'])}}" class="img-fluid rounded-start mx-auto d-block py-2" alt="..." style="max-height: 80px">
                                            </div>
                                            <div class="col-md-10">
                                                ...
                                                <div class="card-text d-flex justify-content-between">
                                                    <p>
                                                        <small class="text-body-secondary">Quantity:</small> {{$item['quantity']}}
                                                    </p>
