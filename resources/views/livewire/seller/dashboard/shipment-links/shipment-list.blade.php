    ...
    <div class="flex h-full">
        <div class="tab-wrapper flex-1 w-64" x-data="{ activeTab: 0 }">
            <div class="flex flex-column flex-lg-row justify-between gap-2 ">
                ...
                <div
                    class="bg-white w-full p-1 h-full border-gray-200 !rounded-lg text-sm focus:outline-none lg:items-center mb-2">
            ...
            <div class="tab-panel bg-white overflow-x-auto rounded-lg p-3" :class="{ 'active': activeTab === 0 }"
                ...
                <div class="grid grid-cols-12 text-center text-sm">
                    ...
                    <div class="col-span-2 p-2 !text-gray-400 !font-light border-b-2 border-blue-300">Total Price</div>
                                                ...
                                                <div class="p-1.5 lg:w-1/2">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" id="product_name"
                                                            value="{{ $item->title }}" wire:model.blur="product_name"
                                                        ...
                                                        <div>
                                                            ...
                                                            @if ($item->date_of_payment == null)
                                                                <input type="text" id="date_of_payment"
                                                                    value="unpaid" wire:model.blur="date_of_payment"
            ...
            <div class="tab-panel bg-white overflow-x-auto rounded-lg p-3" :class="{ 'active': activeTab === 1 }"
                x-show.transition.in.opacity.duration.600="activeTab === 1">
                shipping
            </div>
            <div class="tab-panel bg-white overflow-x-auto rounded-lg p-3" :class="{ 'active': activeTab === 2 }"
