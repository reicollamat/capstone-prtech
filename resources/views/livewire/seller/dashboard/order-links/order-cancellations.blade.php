    ...
    <div class="flex h-full">
        ...
        <div class="bg-white overflow-x-auto rounded-lg p-3">
            ...
            <div wire:loading.remove x-transition>
                @if ($this->getCancellations->count() > 0)
                    @foreach ($this->getCancellations as $item)
        ...
        <div
            ...
            <div class="w-full h-fit py-6 pr-4 rounded-lg shadow pl-3 justify-center bg-white">
                ...
                <div class="py-2 text-center">
                    <p class="text-sm font-base text-gray-500 mb-1">Total Cancelations Listed</p>
                    <p class="font-semibold">{{ $this->getTotalCancellations }}</p>
                </div>
            </div>
        </div>
    </div>
