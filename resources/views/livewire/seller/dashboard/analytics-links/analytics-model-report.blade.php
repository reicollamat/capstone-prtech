                ...
                <div class="flex items-center justify-between mb-3">
                    ...
                    <div class="btn-group btn-group-sm" role="group">
                        ...
                        <button type="button" class="btn btn-outline-primary dropdown-toggle"
                            ...
                            {{ $mostBoughtProducts }} Days Filter
                        </button>
                        <ul class="dropdown-menu !pl-0">
                            <li>
                                <button type="button" wire:click="$set('mostBoughtProducts', '7')"
                                        class="dropdown-item" href="#">7 Days
                                </button>
                            </li>
                            <li>
                                <button type="button" wire:click="$set('mostBoughtProducts', '30')"
                                        class="dropdown-item" href="#">1 Month
                                </button>
                            </li>
                            <li>
                                <button type="button" wire:click="$set('mostBoughtProducts', '90')"
                                        class="dropdown-item" href="#">2 Months
                                </button>
                            </li>
                            <li>
                                <button type="button" wire:click="$set('mostBoughtProducts', '180')"
