<div class="card {{ $notification->read_at ? '' : 'bg-primary-subtle' }} mb-2" x-transition x-data="{ isSellerNotificationOpen: false }"
            ...
            <div class="card">
                <div class="list-group">
                    ...
                    <a href="{{ route('product-list') }}" class="list-group-item list-group-item-action">View
                        Product</a>
                    <a href="{{ route('analytics-model-report') }}" class="list-group-item list-group-item-action">View
                        StockSense</a>
                    <button wire:key="linktodelete" wire:click="$parent.delete_notif('{{ $notification->id }}')"
                        class="list-group-item list-group-item-action">
                        Delete
                    </button>
                </div>
