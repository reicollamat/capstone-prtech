<div>
    ...
    <div class="grid md:grid-cols-2 gap-4">
        <div>
            ...
            <div class="grid md:grid-cols-2 gap-4">
                <div class="mb-4">
                    <label for="cpu_name" class="block mb-1 text-sm font-medium text-gray-800 dark:text-white  pl-1">CPU
                        Brand, Name, Title
                    </label>
            ...
            <!-- CPU Base Clock -->
            <div class="mb-4">
                <label for="base_clock" class="block mb-1 text-sm font-medium text-gray-800 dark:text-white  pl-1">Base
                    Clock</label>
