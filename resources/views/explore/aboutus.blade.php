...
@section('content')
    ...
    <div class="container mb-20">
        ...
        <div class="col-md-4 mb-4">
            ...
            <img
                src="https://www.interdiligence.com/wp-content/uploads/2021/11/analiza-de-piata.jpg"
        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100">
            <img
                src="https://images.jpost.com/image/upload/f_auto,fl_lossy/c_fill,g_faces:center,h_428,w_640/472557"
                class="card-img-top image-card"
                alt="Card Image"
            />
            <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100">
            <img
                src="https://www.perforce.com/sites/default/files/image/2021-05/image-blog-iso.jpg"
                class="card-img-top image-card"
                alt="Card Image"
            />
            <div class="card-body">
