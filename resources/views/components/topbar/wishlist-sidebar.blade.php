<div>
    ...
    <div class="offcanvas offcanvas-end min-w-[500px]" data-bs-scroll="true" tabindex="-1"
         id="offcanvasWithBothOptions_wishlist"
         aria-labelledby="offcanvasWithBothOptionsLabel">
        <div class="offcanvas-header px-4">
            <div class="d-flex align-middle self-center py-2 items-center text-gray-600">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                     class="bi bi-bag-heart " viewBox="0 0 16 16">
                    <path fill-rule="evenodd"
                          d="M10.5 3.5a2.5 2.5 0 0 0-5 0V4h5v-.5Zm1 0V4H15v10a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V4h3.5v-.5a3.5 3.5 0 1 1 7 0ZM14 14V5H2v9a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1ZM8 7.993c1.664-1.711 5.825 1.283 0 5.132-5.825-3.85-1.664-6.843 0-5.132Z"/>
                </svg>
                <h5 class="offcanvas-title pl-2" id="offcanvasWithBothOptionsLabel">
                    @livewire('wishlist.wishlistcount') Wishlist Item/s</h5>
            </div>
            <button type="button" class="btn-close" data-bs-dismiss="offcanvas"
                    aria-label="Close"></button>
        </div>
        <hr class="mt-1.5 mb-1.5">
        <div class="offcanvas-body my-0 py-2">
            <div>
